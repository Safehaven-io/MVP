...
<script type="text/javascript" src="<?php echo $rootadmin; ?>js/tfc-le.js"></script>
...
<div id="page-title">
	<h2>The Family Cirle - Legal Entity</h2>
	<p>With the TFC plan, you can split your shares through your relatives.</p>
</div>

<div class="panel" ng-controller="tfcLeCtrl">
    <div class="panel-body">
		<div class="example-box-wrapper">
            <div id="form-wizard-tfc-le" class="form-wizard">
				<ul>
                    <li>
									...
									<div class="row">
										<div class="col-md-12">
											<div style='float: right;'>
											    <button class="btn btn-primary" ng-click="check()">Unlock</button>
